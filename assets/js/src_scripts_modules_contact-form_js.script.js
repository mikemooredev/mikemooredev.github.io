...
var _default = /*#__PURE__*/function (_Module) {
  ...
  _createClass(_default, [{
    ...
    value: function contactFormSubmit(e) {
      ...
      if (this.contactFormValidate()) {
        ...
        fetch(this.els.formEl.action, {
          ...
          _this2.els.notificationEl.innerHTML = 'Thanks for your submission!';
          form.reset();
        }).catch(function (error) {
          _this2.els.notificationEl.innerHTML = 'Oops! There was a problem submitting your form';
        });
      }
    }
  }, {
    ...
    key: "methods",
    get: function get() {
      return ['setupData', 'contactFormSubmit', 'contactFormValidate', 'validateEmail', 'validatePhone', 'validateInput', 'regexTest', 'setNotificationHTML'];
    }
  }]);
