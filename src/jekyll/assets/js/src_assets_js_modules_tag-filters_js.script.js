(self["webpackChunkmikemooredev"] = self["webpackChunkmikemooredev"] || []).push([["src_assets_js_modules_tag-filters_js"],{
  ...
  _createClass(Module, [{
    ...
    value: function setupEls() {
      ...
      els.forEach(function (el) {
        var alias = el.dataset.el.replace("".concat(_this2.identifier, "."), "").replace(/-([a-z])/g, function (m, w) {
    ...
    key: "defaultMethods",
    get: function get() {
      return ['initialize', 'setup', 'setupEls', 'setupListeners'];
    }
  }, {
    key: "methods",
    get: function get() {
...
/***/ "./src/assets/js/modules/tag-filters.js":
/*!**********************************************!*\
  !*** ./src/assets/js/modules/tag-filters.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils_helpers__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../utils/helpers */ "./src/assets/js/utils/helpers.js");
/* harmony import */ var _module_Module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./module/Module */ "./src/assets/js/modules/module/Module.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var _default = /*#__PURE__*/function (_Module) {
  ...
  _createClass(_default, [{
    ...
    value: function setupListeners() {
      ...
      if (this.els.tagEls) {
        this.els.tagEls.forEach(function (tagEl) {
          return tagEl.addEventListener("click", function (event) {
    ...
    value: function handleTagClick(event) {
      ...
      var tagHandle = linkEl.dataset.tagHandle ? linkEl.dataset.tagHandle : null;
      this.filterPosts(tagHandle);
      history.pushState({}, null, linkEl.getAttribute("href"));
    }
  }, {
    key: "filterPosts",
    value: function filterPosts(tagHandle) {
      var _this2 = this;

      var posts = this.postData[tagHandle] ? this.postData[tagHandle] : [];

      if (this.els.itemsEl && tagHandle.length) {
        this.els.itemsEl.innerHTML = "";
        posts.forEach(function (post) {
          _this2.els.itemsEl.innerHTML += _this2.articleCardTemplate.replace("href=\"\"", "href=\"".concat(post.url, "\"")).replace("title=\"\"", "title=\"".concat(post.title, "\"")).replace("src=\"\"", "src=\"".concat(_this2.thumbnailPath).concat(post.thumbnail, "\"")).replace("alt=\"\"", "alt=\"".concat(post.thumbnail_alt, "\"")).replace("<!--[title]-->", post.title).replace("<!--[excerpt]-->", post.excerpt);
        });
      }
    }
  }, {
    ...
    key: "currentTag",
    get: function get() {
      return (0,_utils_helpers__WEBPACK_IMPORTED_MODULE_14__.getParameterByName)("tag");
    }
  }, {
    key: "methods",
    get: function get() {
  ...
  return _default;
}(_module_Module__WEBPACK_IMPORTED_MODULE_15__.default);
...
//# sourceMappingURL=src_assets_js_modules_tag-filters_js.script.js.map